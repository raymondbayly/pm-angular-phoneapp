(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@ionic/storage'), require('@auth0/angular-jwt'), require('@auth0/angular-jwt/src/jwthelper.service'), require('rxjs'), require('ng-common-library'), require('rxjs/operators'), require('@angular/platform-browser'), require('@angular/forms'), require('@angular/core'), require('@angular/common/http')) :
    typeof define === 'function' && define.amd ? define('ng-login-library', ['exports', '@ionic/storage', '@auth0/angular-jwt', '@auth0/angular-jwt/src/jwthelper.service', 'rxjs', 'ng-common-library', 'rxjs/operators', '@angular/platform-browser', '@angular/forms', '@angular/core', '@angular/common/http'], factory) :
    (factory((global['ng-login-library'] = {}),global.i2,global.angularJwt,global.i3,global.rxjs,global.i5,global.rxjs.operators,global.ng.platformBrowser,global.ng.forms,global.ng.core,global.ng.common.http));
}(this, (function (exports,i2,angularJwt,i3,rxjs,i5,operators,platformBrowser,forms,i0,i1) { 'use strict';
    ...
    var LoginService = /** @class */ (function () {
        ...
        LoginService.prototype.checkLogin = /*
            ...
            function () {
                var _this = this;
                this.tokenService.token$.pipe(operators.first()).subscribe(function (token) {
                    if (!token) {
         ...
         */
            function () {
                if (this.getCurrentUser() && this.getCurrentUser().username) {
                    this.http.post(this.loginConfigService.getLogoutUrl(), this.getCurrentUser()).pipe(operators.first()).subscribe(function () {
        ...
        LoginService.ctorParameters = function () {
            return [
                ...
                { type: i5.TokenApiService }
            ];
        };
        /** @nocollapse */ LoginService.ngInjectableDef = i0.defineInjectable({ factory: function LoginService_Factory() { return new LoginService(i0.inject(i1.HttpClient), i0.inject(i2.Storage), i0.inject(i3.JwtHelperService), i0.inject(LoginConfigService), i0.inject(i5.TokenApiService)); }, token: LoginService, providedIn: "root" });
        return LoginService;
    }());
    ...
    var LoginIpService = /** @class */ (function () {
        ...
        /** @nocollapse */
        LoginIpService.ctorParameters = function () {
            return [
                { type: i1.HttpClient },
                { type: LoginService }
            ];
        };
        /** @nocollapse */ LoginIpService.ngInjectableDef = i0.defineInjectable({ factory: function LoginIpService_Factory() { return new LoginIpService(i0.inject(i1.HttpClient), i0.inject(LoginService)); }, token: LoginIpService, providedIn: "root" });
    ...
    var LoginComponent = /** @class */ (function () {
         ...
         */
            function () {
                if (!this.loginService.getCurrentUser()) {
                    this.loginService.setCurrentUser(new i5.User());
                }
         ...
         */
            function () {
                ...
                this.loginLibraryIpService.loginIp$.pipe(operators.first()).subscribe(function (loginIp) {
                    if (loginIp) {
                        _this.loginInfo = loginIp;
                    }
                    else {
         ...
         */
            function () {
                ...
                if (user.username && this.userPassword) {
                    ...
                    this.loginService.login$.pipe(operators.first()).subscribe(function (usr) {
                        if (!usr) {
                            /*
        ...
        LoginComponent.propDecorators = {
            vc: [{ type: i0.ViewChildren, args: ['input',] }]
        };
    ...
    exports.LoginIpService = LoginIpService;
    exports.LoginConfigService = LoginConfigService;
    exports.LoginComponent = LoginComponent;
    exports.LoginModule = LoginModule;
    exports.LoginIp = LoginIp;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=ng-login-library.umd.js.map